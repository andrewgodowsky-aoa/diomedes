...
export type BoardProps = { project: Project; state: ProjectState; tasks: Task[]; policy: 'first' | 'go'; focusTaskId?: string; busy: boolean;
...
export type PaletteProps = { open: boolean; entries(query: string): PaletteEntry[]; onClose(): void };
