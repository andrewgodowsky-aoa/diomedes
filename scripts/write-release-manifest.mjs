...
const ledger = { schemaVersion: 1, releaseId, appVersion: '0.1.1', statusVocabulary: ['VERIFIED', 'PARTIAL', 'MISSING', 'DEFERRED'],
  capabilities: [
    capability('desktop-connections', 'VERIFIED', ['source', 'fixture', 'packaged', 'installer'], 'Connections in Console and Workbook with reviewed three-location synthetic scope, incomplete-intent questions and freshness.', 'Bounded Toast intent template; no general language-to-arbitrary-connector construction.'),
