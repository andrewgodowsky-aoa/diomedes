...
export class AutomationService {
  ...
  private async automationView(
    ...
    // interrupted before its run started still reads as needing investigation. Missed and
    // skipped schedule slots are refused occurrences too: the schedule shows them, not the label.
