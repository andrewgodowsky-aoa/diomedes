...
import type { CapRequestRow, CreditAdjustmentRow, CreditPeriodRow, FundedJobRow, FundingRepository, FundingTransaction,
  JobRefRow, TopUpRow } from '../../src/funding.js';
...
const empty = (): FundingState => ({ periods: [], jobs: [], jobRefs: [], attempts: [], settlements: [], adjustments: [], topUps: [], capRequests: [] });
...
class StateFundingTransaction implements FundingTransaction {
